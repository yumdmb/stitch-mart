          ...
          <div className="px-3 py-2 text-bg-blue">
            <div className="container">
              <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div className="text-end ms-lg-4 d-flex align-items-center justify-content-center">
                        <a
                            href=""
                            className="nav-link d-flex flex-column align-items-center justify-content-center text-white"
                        ...
                        >
                            <svg
                                ...
                                height="24"
                                fill="#FFBA42"
                                className="bi bi-person-circle mb-1"  // Added mb-1 for a small margin below the icon
                                viewBox="0 0 16 16"
                            >
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                                <path
