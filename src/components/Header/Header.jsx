            ...
            <div className="container">
              <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="" className="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                  <img src="horizontal-logo.png" alt="Logo" width="160" height="53" />
                </a>
                ...
                <li>
                  ...
                  <li>
                    <a href="" className="nav-link d-flex flex-column align-items-center justify-content-center text-white">
                      <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-backpack3-fill" viewBox="0 0 16 16">
