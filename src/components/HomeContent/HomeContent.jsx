...
const HomeContent = () => {
    return (
        <div className="container-fluid col-xxl-8 px-4 py-5" style={{backgroundColor: "#FFBA42"}}>
            ...
            <div className="col-lg-6">
                <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3">Experience the art of embroidery crafted just for you.</h1>
